...
class CenteredAverageTestCase(TestCase):
    def test_centered_average_view(self):
        ...
        centered_average_response = self.client.post(
            "/list-2/centered-average/", {"nums": "1, 2, 3, 4, 100"}
        )
